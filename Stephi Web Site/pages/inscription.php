...
if (isset($_POST['submit']))
{
   /* on test si les champ sont bien remplis */
    if(!empty($_POST['nom']) and !empty($_POST['prenom']) and !empty($_POST['email']) and !empty($_POST['password']) and !empty($_POST['repeatpassword']) and !empty($_POST['genre']) and !empty($_POST['adresse']) and !empty($_POST['code_postal']) and !empty($_POST['ville']) and !empty($_POST['pays']) and !empty($_POST['numero']) and !empty($_POST['date_de_naissance']) and !empty($_POST['agence']) )
    {
        ...
        if (strlen($_POST['password'])>=6)
        {
            ...
            if ($_POST['password']==$_POST['repeatpassword'])
            {
                ...
                //On créé la requête
                $sql = "INSERT INTO client VALUES ('".$_POST['nom']."','".$_POST['prenom']."','".$_POST['email']."','".$_POST['password']."','".$_POST['genre']."','".$_POST['adresse']."','".$_POST['code_postal']."','".$_POST['ville']."','".$_POST['pays']."','".$_POST['numero']."','".$_POST['date_de_naissance']."','".$_POST['agence']."',NULL)";
